  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto pt-20 pb-0 px-4 md:px-8 lg:px-10 text-center">
        <h2 className="text-3xl md:text-4xl mb-1 text-black dark:text-white font-bold text-indigo-900">
          My Experiences
        </h2>
        <p className="text-xl text-neutral-700 dark:text-neutral-300 text-sm md:text-base">
